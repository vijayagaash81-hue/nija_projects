            ...
            try {
                ...
                for (var i = 0; i < numAddresses; i++) {
                    ...
                    if (isDefaultBilling) {
                        ...
                        addressData.addressee = escapeXml(addressSubrecord.getValue('addressee') || '');
                        addressData.addr1 = escapeXml(addressSubrecord.getValue('addr1') || '');
                        addressData.country = escapeXml( addressSubrecord.getText('country') || addressSubrecord.getValue('country') || '');
                        addressData.zip = escapeXml(addressSubrecord.getValue('zip') || '');
                        addressData.state = escapeXml(addressSubrecord.getValue('state') || '');
                        addressData.city = escapeXml(addressSubrecord.getValue('city') || '');
