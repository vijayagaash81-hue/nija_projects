    ...
    function(task, serverWidget, runtime) {
        ...
        function onRequest(context) {
            ...
            var form = serverWidget.createForm({
                title: ' Monthly attendance Creation Status'
            });
            ...
            mrstatus.updateDisplayType({
             ...
             form.clientScriptModulePath = './hris_dailymanualtomonthly_status_cs';
            ...
            template += '</head>';
            template += '<body>';
            template += '<strong>Monthly Attendance Creation Status: <span style="color:blue">' + tskstatus + '</span></strong><br/><br/>';
