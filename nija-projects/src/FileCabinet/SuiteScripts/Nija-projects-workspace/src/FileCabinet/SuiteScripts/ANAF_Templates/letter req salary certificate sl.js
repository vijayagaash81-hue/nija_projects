        ...
        try {
            ...
            if (logoUrl) {
                logoHtmlElement = '<table width="130" height="70"><tr><td align="center" valign="middle">' +
                    '<img src="' + escapeXml(logoUrl) + '" width="110" height="80" />' +
                    '</td></tr></table>';
            } else {
            ...
            var pdfContent = '<?xml version="1.0" encoding="UTF-8"?>' +
                ...
                (certType === '2' ?
                    ...
                    '<img src="https://11929899.app.netsuite.com/core/media/media.nl?id=26265&amp;c=11929899&amp;h=loH0FyifzDuKFUwvK6UeT6YSaqDnsUyU9YkBrCZthdhWm8UA" width="100%" style="margin: 0; padding: 0;" />' +
                    '</td></tr></table>' +
                    '</macro>' +
                    '<macro id="offerfooter">' +
                    '<table width="100%" style="border-collapse: collapse; margin: 0; padding-top: 50;">' +
                    '<tr><td align="center" style="margin: 0; padding: 0;">' +
                    '<img src="https://11929899.app.netsuite.com/core/media/media.nl?id=26264&amp;c=11929899&amp;h=A2Qn3Ku0_NO6Q0uaH1kR7rjel2vuC0Kt0OnwpQls3ycHW2MA" width="100%" height="45" style="margin: 0; padding: 0;" />' +
                    '</td></tr></table>' +
                    '</macro>' : '') +
                '</macrolist>' +
                '</head>' +
