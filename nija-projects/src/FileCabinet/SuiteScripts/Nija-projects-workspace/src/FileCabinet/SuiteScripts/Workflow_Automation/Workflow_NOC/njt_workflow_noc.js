...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecordnoc_approval_status',
        approval_setup: 'custrecord_approval_setup_t1',
        current_level: 'custrecord_current_level_t1',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecordnoc_next_approver',
        rejection_reason: 'custrecord_noc_rejectionreason',
        approval_requestor: 'custrecord_approval_requestor_t1',
        department: 'custrecord_noc_department',
        email_recipient_field: 'custrecord_employee',
        email_cc: [
        ...
        email_template_approved: {
            title: 'NOC Approved',
            subject: 'NOC Approved - {tranid}',
            body: '<p>Dear {custrecord_employee},</p>' +
                '<p>Your NOC is approved.</p>' +
                '<p>Employee Name: {custrecord_employee}<br />' +
                'Department: {custrecord_noc_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            title: 'NOC Rejected',
            subject: 'NOC Rejected - {tranid}',
            body: '<p>Dear {custrecord_employee},</p>' +
                '<p>Your NOC is Rejected.</p>' +
                '<p>Employee Name: {custrecord_employee}<br />' +
                'Department: {custrecord_noc_department}</p>' +
                '<p>Thank you</p>'
        },
