...
function(currentRecord, format,log) {
    ...
    function fieldChanged(context) {
        try {
            ...
            if (context.fieldId === 'custrecord_rejoin_reques_resumption_date') {
                
                var expReturnDateStr = recordObj.getValue('custrecord_rejoin_reques_exp_return_date');
                var resumptionDateStr = recordObj.getValue('custrecord_rejoin_reques_resumption_date');
                ...
                if (expReturnDateStr && resumptionDateStr) {
                  ...
                  var totalDelayDays=daysDiff+1
                    ...
                    recordObj.setValue({
                        fieldId: 'custrecord_rejoin_reque_total_delay_days',
