...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_dm_approval_status',
        approval_setup: 'custrecord_approval_setup_dm',
        current_level: 'custrecord_current_level_dm',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_dm_next_approver',
        rejection_reason: 'custrecord_dm_reason_for_rejection',
        approval_requestor: 'custrecord_approval_requestor_dm',
        department: 'custrecord_dm_department',
        email_recipient_field: 'custrecord_dm_employee',
        email_cc: [
        ...
        email_template_approved: {
            title: 'Disciplinary Memo',
            subject: 'Disciplinary Memo - {tranid}',
            body: '<p>Dear {custrecord_dm_employee},</p>' +
                '<p>Your Disciplinary Memo is approved.</p>' +
                '<p>Employee Name: {custrecord_dm_employee}<br />' +
                'Department: {custrecord_dm_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Disciplinary Memo - {tranid}',
            body: '<p>Dear {custrecord_dm_employee},</p>' +
                '<p>Your Disciplinary Memo is Rejected.</p>' +
                '<p>Employee Name: {custrecord_dm_employee}<br />' +
                'Department: {custrecord_dm_department}</p>' +
                '<p>Thank you</p>'
        },
