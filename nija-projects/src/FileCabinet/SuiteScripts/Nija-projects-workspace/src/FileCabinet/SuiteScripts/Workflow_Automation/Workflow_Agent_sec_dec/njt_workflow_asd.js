...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_asd',
        approval_setup: 'custrecord_approval_setup_asd',
        current_level: 'custrecord_current_level_asd',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approval_role_asd',
        rejection_reason: 'custrecord_rejection_reason_asd',
        approval_requestor: 'custrecord_approval_requestor_asd',
        department: 'custrecord_department_asd',
        email_recipient_field: 'custrecord_approval_requestor_asd',
        // email_cc: [
        ...
        email_template_approved: {
            title: 'Agent Security Deposit Collection',
            subject: 'Agent Security Deposit Collection - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_asd},</p>' +
                '<p>Your Agent Security Deposit Collection is approved.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_asd}<br />' +
                'Department: {custrecord_department_asd}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Agent Security Deposit Collection - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_asd},</p>' +
                '<p>Your Agent Security Deposit Collection is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_asd}<br />' +
                'Department: {custrecord_department_asd}</p>' +
                '<p>Thank you</p>'
        },
