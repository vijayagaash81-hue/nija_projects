    ...
    try {
      ...
      if (searchResult.length > 0) {
        ...
        recordsData.forEach(function (recordData) {
          ...
          var workingHours = parseFloat(existingRecord.getValue({
            fieldId: "custrecord_njt_emp_daily_working_hours",
          })) || 0;
          var actualHours = parseFloat(workhoursdecimal) || 0;

          var otHour = 0;
          if (actualHours > workingHours) {
            otHour = parseFloat((actualHours - workingHours).toFixed(2));
          }
          ...
          if (attenMethod === "1") {
            ...
            existingRecord.setValue({ fieldId: "custrecord_njt_ot_hours", value: otHour });
