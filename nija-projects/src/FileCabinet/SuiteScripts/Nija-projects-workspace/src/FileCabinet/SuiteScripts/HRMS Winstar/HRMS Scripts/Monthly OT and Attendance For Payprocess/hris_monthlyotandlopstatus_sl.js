    ...
    function(task, serverWidget, runtime) {
        ...
        function onRequest(context) {
            ...
            var form = serverWidget.createForm({
                title: 'Employee Monthly attendance Process'
            });
            ...
            mrstatus.updateDisplayType({
             ...
             form.clientScriptModulePath = './hris_monthlyotandlopstatus_cs.js';
            ...
            template += '</head>';
            template += '<body>';
            template += '<strong>Employee Monthly attendance Process Status: <span style="color:blue">' + tskstatus + '</span></strong><br/><br/>';
