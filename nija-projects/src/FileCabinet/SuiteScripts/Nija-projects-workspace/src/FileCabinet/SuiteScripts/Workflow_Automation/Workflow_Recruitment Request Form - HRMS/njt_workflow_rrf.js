...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_rrf',
        approval_setup: 'custrecord_approval_setup_rrf',
        current_level: 'custrecord_current_level_rrf',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approver_role_rrf',
        rejection_reason: 'custrecord_rejection_reason_rrf',
        approval_requestor: 'custrecord_approval_requestor_rrf',
        department: 'custrecord_department_rrf',
        email_recipient_field: 'custrecord_approval_requestor_rrf',
        // email_cc: [
        ...
        email_template_approved: {
            title: 'Recruitment Request Form - HRMS',
            subject: 'Recruitment Request Form - HRMS - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_rrf},</p>' +
                '<p>Your Recruitment Request Form - HRMS is approved.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_rrf}<br />' +
                'Department: {custrecord_department_rrf}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Recruitment Request Form - HRMS - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_rrf},</p>' +
                '<p>Your Recruitment Request Form - HRMS is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_rrf}<br />' +
                'Department: {custrecord_department_rrf}</p>' +
                '<p>Thank you</p>'
        },
