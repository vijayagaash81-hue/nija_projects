...
define(['N/log'], function(log) {
    ...
    function convertAmountToWords(amount, currencyText) {
        ...
        if (decimal > 0) {
            // Dynamic decimal name based on currency
            var decimalName = 'Cents'; // Default
            if (currencyText === 'AED') {
                decimalName = 'Fils';
            }
            // Add more currency conditions here if needed
    ...
    function beforeSubmit(context) {
        ...
        try {
            ...
            // Retrieve the currency text (e.g., "USD", "AED")
            var currencyText = newRecord.getText({ fieldId: 'currency' });
