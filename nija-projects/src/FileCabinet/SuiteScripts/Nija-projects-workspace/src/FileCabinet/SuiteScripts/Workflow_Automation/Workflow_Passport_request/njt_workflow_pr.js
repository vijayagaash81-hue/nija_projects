...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hris_pass_approvalstatus',
        approval_setup: 'custrecord_approval_setup_pr',
        current_level: 'custrecord_current_level_pr',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_hris_pass_next_approver',
        rejection_reason: 'custrecord_hris_pas_reason_for_rejection',
        approval_requestor: 'custrecord_hris_pass_new_requestor',
        department: 'custrecord_hris_pass_department',
        email_recipient_field: 'custrecord_hris_pass_empname',
        email_cc: [
        ...
        email_template_approved: {
            title: 'HR Passport Request',
            subject: 'HR Passport Request - {tranid}',
            body: '<p>Dear {custrecord_hris_pass_empname},</p>' +
                '<p>Your Passport Request is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_pass_empname}<br />' +
                'Department: {custrecord_hris_pass_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'HR Passport Request - {tranid}',
            body: '<p>Dear {custrecord_hris_pass_empname},</p>' +
                '<p>Your Passport Request is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_pass_empname}<br />' +
                'Department: {custrecord_hris_pass_department}</p>' +
                '<p>Thank you</p>'
        },
