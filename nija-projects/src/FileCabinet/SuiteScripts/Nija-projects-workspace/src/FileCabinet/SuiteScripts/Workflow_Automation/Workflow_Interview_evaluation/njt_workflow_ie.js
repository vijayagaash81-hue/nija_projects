...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hr_interview_evl_app_status',
        approval_setup: 'custrecord_approval_setup_ie',
        current_level: 'custrecord_current_level_ie',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_hr_interview_evl_next_app',
        rejection_reason: 'custrecord_hr_interviewiew_rsn_for_rej',
        approval_requestor: 'custrecord_approval_requestor_ie',
        department: 'custrecord_hr_interview_evl_dept',
        email_recipient_field: 'custrecord_hr_interview_candidate_name',
        email_cc: [
        ...
        email_template_approved: {
            title: 'HRIS Interview Evaluation Form',
            subject: 'HRIS Interview Evaluation Form - {tranid}',
            body: '<p>Dear {custrecord_hr_interview_candidate_name},</p>' +
                '<p>Your HRIS Interview Evaluation Form is approved.</p>' +
                '<p>Employee Name: {custrecord_hr_interview_candidate_name}<br />' +
                'Department: {custrecord_hr_interview_evl_dept}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'HRIS Interview Evaluation Form - {tranid}',
            body: '<p>Dear {custrecord_hr_interview_candidate_name},</p>' +
                '<p>Your HRIS Interview Evaluation Form is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hr_interview_candidate_name}<br />' +
                'Department: {custrecord_hr_interview_evl_dept}</p>' +
                '<p>Thank you</p>'
        },
