...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hris_res_approvalstatus',
        approval_setup: 'custrecord_approval_setup_re',
        current_level: 'custrecord_current_level_re',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_hris_res_next_approver',
        rejection_reason: 'custrecord_hris_res_reason_for_rejection',
        approval_requestor: 'custrecord_approval_requestor_re',
        department: 'custrecord_hris_res_department',
        email_recipient_field: 'custrecord_hris_res_employee_code',
        email_cc: [
        ...
        email_template_approved: {
            ...
            body: '<p>Dear {custrecord_hris_res_employee_code},</p>' +
