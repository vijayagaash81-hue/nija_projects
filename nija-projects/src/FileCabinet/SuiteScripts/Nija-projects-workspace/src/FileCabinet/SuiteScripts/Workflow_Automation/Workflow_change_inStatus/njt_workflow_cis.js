...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hris_cis_approval_status',
        approval_setup: 'custrecord_approval_setup_cis',
        current_level: 'custrecord_current_level_cis',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_hris_cis_next_approver',
        rejection_reason: 'custrecord_hris_cis_rsn_for_rejection',
        approval_requestor: 'custrecord_approval_requestor_cis',
        department: 'custrecord_hris_cis_department',
        email_recipient_field: 'custrecord_approval_requestor_cis',
        email_cc: [
        ...
        email_template_approved: {
            title: 'Change In Status Form',
            subject: 'Change In Status Form - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_cis},</p>' +
                '<p>Your Change In Status Form is approved.</p>' +
                'Department: {custrecord_hris_cis_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Change In Status Form - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_cis},</p>' +
                '<p>Your Change In Status Form is Rejected.</p>' +
                'Department: {custrecord_hris_cis_department}</p>' +
                '<p>Thank you</p>'
        },
