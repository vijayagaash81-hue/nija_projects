...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hris_emp_tras_approval_status',
        approval_setup: 'custrecord_approval_setup_et',
        current_level: 'custrecord_current_level_et',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_hris_emp_tras_next_approver',
        rejection_reason: 'custrecord_hris_emp_reason_for_rejection',
        approval_requestor: 'custrecord_approval_requestor_et',
        department: 'custrecord_hris_emp_department',
        ...
        email_template_approved: {
            ...
            subject: 'Employee Transfer - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_et},</p>' +
                '<p>Your Employee Transfer is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_pass_empname}<br />' +
                'Department: {custrecord_hris_emp_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Employee Transfer - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_et},</p>' +
                '<p>Your Employee Transfer is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_pass_empname}<br />' +
                'Department: {custrecord_hris_emp_department}</p>' +
                '<p>Thank you</p>'
        },
