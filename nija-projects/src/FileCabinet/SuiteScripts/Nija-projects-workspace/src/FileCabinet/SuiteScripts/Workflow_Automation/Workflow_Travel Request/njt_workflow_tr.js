...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_htr',
        approval_setup: 'custrecord_approval_setup_htr',
        current_level: 'custrecord_current_level_htr',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approval_role_htr',
        rejection_reason: 'custrecord_reason_for_rejection',
        approval_requestor: 'custrecord_approval_requestor_htr',
        department: 'custrecord_hris_trarqq_department',
        email_recipient_field: 'custrecord_hris_trarqq_employee_name',
        email_cc: [
        ...
        email_template_approved: {
            ...
            subject: 'Travel Request Form - {tranid}',
            body: '<p>Dear {custrecord_hris_trarqq_employee_name},</p>' +
                '<p>Your Travel Request Form is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_trarqq_employee_name}<br />' +
                'Department: {custrecord_hris_trarqq_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Travel Request Form - {tranid}',
            body: '<p>Dear {custrecord_hris_trarqq_employee_name},</p>' +
                '<p>Your Travel Request Form is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_trarqq_employee_name}<br />' +
                'Department: {custrecord_hris_trarqq_department}</p>' +
                '<p>Thank you</p>'
        },
