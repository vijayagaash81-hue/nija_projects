...
define(['N/ui/serverWidget'], function (serverWidget) {
    ...
    function beforeLoad(context) {
        ...
        form.addButton({
            id: 'custpage_print_rec_vou_btn',
            label: 'Print Receipt Voucher',
            functionName: 'printReceiptVoucher()' // Function defined in the inline script below
        });

        // Inject Client-Side logic directly into the form via an INLINEHTML field
        var inlineHtmlField = form.addField({
            id: 'custpage_rec_vou_inline_script',
        ...
        inlineHtmlField.defaultValue = "<script>" +
            ...
            "           scriptId: 'customscript_rec_vou_print_sl', " +     // Ensure this matches your Suitelet Script ID
            "           deploymentId: 'customdeploy_rec_vou_print_sl', " + // Ensure this matches your Suitelet Deployment ID
