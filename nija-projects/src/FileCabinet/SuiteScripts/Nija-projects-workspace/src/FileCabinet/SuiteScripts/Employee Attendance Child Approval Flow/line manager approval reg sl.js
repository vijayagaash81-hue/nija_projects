    ...
    function (serverWidget, searchModule, logModule, taskModule, redirectModule, recordModule, runtimeModule, format, query, currentRecord, https, urlMod) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === "GET") {
                ...
                // Get Current User ID (Line Manager)
                ...
                // Always set the header Employee field to the current logged-in Line Manager
            ...
            // -----------------------------------------------------------------
                ...
                var mrTask = taskModule.create({
                    ...
                    scriptId: "customscript_hris_linemanager_approval_r",
                    params: {
                        custscript_njt_column_array_line: JSON.stringify(selectArray)
                    }
                });
        ...
        function setSublistvalue(sublist, query, empPost, fromPost, toPost, currentUserId) {
            ...
            var setsqlquery = "SELECT DISTINCT " + 
                ...
                // --- WHERE CLAUSE ---
                "WHERE employee.custentity_hris_emplinemanger = " + currentUserId + 
