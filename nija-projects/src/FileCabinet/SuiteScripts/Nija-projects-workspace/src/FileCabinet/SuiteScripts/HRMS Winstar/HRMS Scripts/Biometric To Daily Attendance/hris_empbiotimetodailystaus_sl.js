    ...
    function(task, serverWidget, runtime) {
        ...
        function onRequest(context) {
            ...
            var form = serverWidget.createForm({
                title: 'Employee Biometric To  Daily Attendance  Status'
            });
            ...
            mrstatus.updateDisplayType({
             ...
             form.clientScriptModulePath = './hris_empbiotimetodailystaus_cs.js';
            ...
            template += '</head>';
            template += '<body>';
            template += '<strong>Employee Biometric To  Daily Attendance  Status: <span style="color:blue">' + tskstatus + '</span></strong><br/><br/>';
