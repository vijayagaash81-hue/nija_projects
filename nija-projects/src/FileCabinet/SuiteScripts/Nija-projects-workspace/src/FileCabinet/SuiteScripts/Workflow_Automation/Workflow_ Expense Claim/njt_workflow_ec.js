...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_hris_claim_approval_status1',
        approval_setup: 'custrecord_approval_setup_ec',
        current_level: 'custrecord_current_level_ec',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approver_role_ec',
        rejection_reason: 'custrecord_reason_for_rejection_ec',
        approval_requestor: 'custrecord_approval_requestor_ec',
        department: 'custrecord_hris_expclaimfrm_department_n',
        email_recipient_field: 'custrecord_hris_exp_claim_frm_employee',
        email_cc: [
        ...
        email_template_approved: {
            title: 'Expense claim',
            subject: 'Expense claim - {tranid}',
            body: '<p>Dear {custrecord_hris_exp_claim_frm_employee},</p>' +
                '<p>Your Expense claim is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_res_employee_code}<br />' +
                'Department: {custrecord_hris_res_department}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Expense claim - {tranid}',
            body: '<p>Dear {custrecord_hris_exp_claim_frm_employee},</p>' +
                '<p>Your Expense claim is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_res_employee_code}<br />' +
                'Department: {custrecord_hris_res_department}</p>' +
                '<p>Thank you</p>'
        },
