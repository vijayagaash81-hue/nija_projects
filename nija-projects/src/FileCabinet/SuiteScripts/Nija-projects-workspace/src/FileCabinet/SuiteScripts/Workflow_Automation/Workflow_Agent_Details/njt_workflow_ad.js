...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_ad',
        approval_setup: 'custrecord_approval_setup_ad',
        current_level: 'custrecord_current_level_ad',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approval_role_ad',
        rejection_reason: 'custrecord_rejection_reason_ad',
        approval_requestor: 'custrecord_approval_requestor_ad',
        department: 'custrecord_department',
        email_recipient_field: 'custrecord_approval_requestor_ad',
        // email_cc: [
        ...
        email_template_approved: {
            ...
            subject: 'Contract Agreement - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_ad},</p>' +
                '<p>Your Contract Agreement is approved.</p>' +
        ...
        email_template_rejected: {
            ...
            subject: 'Contract Agreement - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_ad},</p>' +
                '<p>Your Contract Agreement is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_ad}<br />' +
                'Department: {custrecord_department}</p>' +
                '<p>Thank you</p>'
        },
