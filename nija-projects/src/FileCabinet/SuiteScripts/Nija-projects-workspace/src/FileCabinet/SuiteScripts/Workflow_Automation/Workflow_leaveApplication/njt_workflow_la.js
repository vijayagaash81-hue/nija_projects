...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status',
        approval_setup: 'custrecord_approval_setup',
        current_level: 'custrecord_current_level',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approver_role',
        rejection_reason: 'custrecord_rejection_reason',
        approval_requestor: 'custrecord_approval_requestor',
        department: 'custrecord_hris_lve_department',
        email_recipient_field: 'custrecord_hris_lve_employeename',
        email_cc: [
        ...
        email_template_approved: {
            ...
            subject: 'Leave Application Approved - {tranid}',
            body: '<p>Dear {custrecord_hris_lve_employeename},</p>' +
                '<p>Your leave application is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_lve_employeename}<br />' +
                'Department: {custrecord_hris_lve_department}<br />' +
                'Leave Type: {custrecord_hris_lve_leavetype}<br />' +
                'Leave Start Date: {custrecord_hris_lve_fromdate}<br />' +
                'Leave End Date: {custrecord_hris_lve_todate}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            title: 'Leave Application Rejected',
            subject: 'Leave Application Rejected - {tranid}',
            body: '<p>Dear {custrecord_hris_lve_employeename},</p>' +
                '<p>Your leave application is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_lve_employeename}<br />' +
                'Leave Type: {custrecord_hris_lve_leavetype}<br />' +
                'Leave Start Date: {custrecord_hris_lve_fromdate}<br />' +
                'Leave End Date: {custrecord_hris_lve_todate}</p>' +
        ...
        additional_approved_values: {
            'custrecord_hris_lve_hrmsapprovalstatus': 2 // Approved
        },
        additional_rejected_values: {
            'custrecord_hris_lve_hrmsapprovalstatus': 3 // Rejected
        }
    };
