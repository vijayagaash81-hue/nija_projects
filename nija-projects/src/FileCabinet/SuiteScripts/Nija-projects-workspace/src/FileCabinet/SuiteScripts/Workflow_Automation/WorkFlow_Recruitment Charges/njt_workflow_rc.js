...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_rc',
        approval_setup: 'custrecord_approval_setup_rc',
        current_level: 'custrecord_current_level_rc',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approval_role',
        rejection_reason: 'custrecord_rejection_reason_rc',
        approval_requestor: 'custrecord_approval_requestor_rc',
        department: 'custrecord_department_rc',
        email_recipient_field: 'custrecord_approval_requestor_rc',
        // email_cc: [
        ...
        email_template_approved: {
            title: 'Recruitment Charges',
            subject: 'Recruitment Charges - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_rc},</p>' +
                '<p>Your Recruitment Charges is approved.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_rc}<br />' +
                'Department: {custrecord_department_rc}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Recruitment Charges - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_rc},</p>' +
                '<p>Your Recruitment Charges is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_rc}<br />' +
                'Department: {custrecord_department_rc}</p>' +
                '<p>Thank you</p>'
        },
