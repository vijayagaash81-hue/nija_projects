...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_scd',
        approval_setup: 'custrecord_approval_setup_scd',
        current_level: 'custrecord_current_level_scd',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approver_role_scd',
        rejection_reason: 'custrecord_rejection_reason_scd',
        approval_requestor: 'custrecord_approval_requestor_scd',
        department: 'custrecord_department_scd',
        email_recipient_field: 'custrecord_approval_requestor_scd',
        // email_cc: [
        ...
        email_template_approved: {
            title: 'HR-Shortlisted candidate details',
            subject: 'HR-Shortlisted candidate details - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_scd},</p>' +
                '<p>Your HR-Shortlisted candidate details is approved.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_scd}<br />' +
                'Department: {custrecord_department_scd}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'HR-Shortlisted candidate details - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_scd},</p>' +
                '<p>Your HR-Shortlisted candidate details is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_scd}<br />' +
                'Department: {custrecord_department_scd}</p>' +
                '<p>Thank you</p>'
        },
