    ...
    function (record, search, task, log, format, runtime, url, query) {
        ...
        function getInputData() {
          ...
          try {
                ...
                log.debug({ title: 'Visa Checking Data', details: scriptParams.getParameter({ name: 'custscript_njt_column_array_selectmr' }) });
              ...
              /*   record.submitFields({
                ...
                return JSON.parse(scriptParams.getParameter({ name: 'custscript_njt_column_array_selectmr' }));
            }
