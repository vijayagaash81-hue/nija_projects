...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_aho',
        approval_setup: 'custrecord_approval_setup_aho',
        current_level: 'custrecord_current_level_aho',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approval_role_aho',
        rejection_reason: 'custrecord_reason_for_rejection_aho',
        approval_requestor: 'custrecord_approval_requestor_aho',
        department: 'custrecord_hris_asset_handover_dept_n',
        email_recipient_field: 'custrecord_hris_handover_empname',
        email_cc: [
        ...
        email_template_approved: {
            ...
            subject: 'Resignation Form - {tranid}',
            body: '<p>Dear {custrecord_hris_handover_empname},</p>' +
                '<p>Your Resignation Form is approved.</p>' +
                '<p>Employee Name: {custrecord_hris_handover_empname}<br />' +
                'Department: {custrecord_hris_asset_handover_dept_n}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Resignation Form - {tranid}',
            body: '<p>Dear {custrecord_hris_handover_empname},</p>' +
                '<p>Your Resignation Form is Rejected.</p>' +
                '<p>Employee Name: {custrecord_hris_handover_empname}<br />' +
                'Department: {custrecord_hris_asset_handover_dept_n}</p>' +
                '<p>Thank you</p>'
        },
