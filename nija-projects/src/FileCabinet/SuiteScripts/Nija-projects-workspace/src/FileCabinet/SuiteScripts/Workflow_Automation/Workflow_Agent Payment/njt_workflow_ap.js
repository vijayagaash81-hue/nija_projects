...
define(['N/search', 'N/record', 'N/log', 'N/runtime', 'N/email'], (search, record, log, runtime, email) => {
    ...
    const FIELD_MAPPINGS = {
        status: 'custrecord_approval_status_ap',
        approval_setup: 'custrecord_approval_setup_ap',
        current_level: 'custrecord_current_level_ap',
        next_approver: 'custrecord_next_approver',
        next_approver_role: 'custrecord_next_approver_role_ap',
        rejection_reason: 'custrecord_rejection_reason_ap',
        approval_requestor: 'custrecord_approval_requestor_ap',
        department: 'custrecord_department_ap',
        email_recipient_field: 'custrecord_approval_requestor_ap',
        // email_cc: [
        ...
        email_template_approved: {
            title: 'Agent Payment',
            subject: 'Agent Payment - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_ap},</p>' +
                '<p>Your Agent Payment is approved.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_ap}<br />' +
                'Department: {custrecord_department_ap}</p>' +
                '<p>Thank you</p>'
        },
        email_template_rejected: {
            ...
            subject: 'Agent Payment - {tranid}',
            body: '<p>Dear {custrecord_approval_requestor_ap},</p>' +
                '<p>Your Agent Payment is Rejected.</p>' +
                '<p>Employee Name: {custrecord_approval_requestor_ap}<br />' +
                'Department: {custrecord_department_ap}</p>' +
                '<p>Thank you</p>'
        },
